                    ...
                    <div class="plan-outr mt-2" id="plans-otr" style="position: relative">
                        ...
                        <div id="plan-list-otr">
                            ...
                            <?php if(count($api_service)>0): ?>
                                ...
                                <tbody> -->
                                <?php foreach($api_service as $api): ?>
                                ...
                                <div class="pln-prc-outr">
                                    ...
                                    <div class="value-pln-txt">
                                        ...
                                        <div class="value-list">
                                            <ul>
                                                <li><em><i class="fa fa-signal"></i></em><strong>Carrier: <?php echo $api['carrier_type'] ?> </strong>
                                                </li>
                                                <li>
                                                   Description : N/A
                                                </li> 
                                ...
                                <div class="pln-prc-innr pln-price">
                                <a href="<?php echo $api['website'] ?>" class="btn btn-primary site-btn">Contact</a>
                                </div>

                            <!-- <tr>
                            <td><?php echo $api['company'] ?></td>
                            <td><?php echo $api['carrier_type'] ?></td>
                            </tr> -->
                            </div>
